package com.tsunamicloud.tsunami.world.structure;

import com.tsunamicloud.tsunami.Main;
import com.tsunamicloud.tsunami.mixin.StructureFeatureAccessor;
...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        ...
        StructureFeatureAccessor.callRegister(Main.MOD_ID + ":sky_structures",
