...
//geckolib的例子：PotatoArmorItem
public class SaualpiteArmorItem extends ModArmorItem implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public SaualpiteArmorItem(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        // full set of armor
            ...
            boolean isWearingAll = armorList.containsAll(Arrays.asList(ModItems.SAUALPITE_BOOTS,
