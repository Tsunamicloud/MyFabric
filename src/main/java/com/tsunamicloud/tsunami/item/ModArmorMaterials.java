...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    //new int[]{1, 2, 3, 1} 护甲值从底向上：boots，leggings，chestplate，helmet
    //durabilityMultiplier:耐久值乘以基础值的倍数
    ...
    SAUALPITE("saualpite", 16, new int[]{2, 5, 7, 2}, 28,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0.0f, 0.0f, () -> Ingredient.ofItems(ModItems.SAUALPITE));
